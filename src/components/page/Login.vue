<template>
    <div class="login-wrap">
         <div class="ms-login">
            <div class="ms-title">直播测试造数平台</div>
...
export default {
    data: function(){
        ...
        methods: {
            submitForm(formName) {
                // alert(this.ruleForm.remember_me)
                // alert(1111);
                    ...
                    if (valid) {
                        ...
                        .then((response)=> {
                            ...
                            that.$router.push({ name: 'dashboard'})
                                ...
                                if("non_field_errors" in error.response.data && error.response.status === 400) {
