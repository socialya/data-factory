<template>
    <div class="table">
        ...
        <el-dialog title="添加榜单" :visible.sync="editVisible" width="50%" center  @close="col">
            <el-steps :active="active" finish-status="success" align-center>
              <el-step title="新建榜单项目"></el-step>
              <el-step title="添加配置"></el-step>
              <el-step title="运行方式"></el-step>
            </el-steps>
            <el-form ref="form"  label-width="120px" class="topTable" v-show="active===0" >
                <!-- <el-form-item label="日期">
                    <el-date-picker type="date" placeholder="选择日期" v-model="form.date" value-format="yyyy-MM-dd" style="width: 100%;"></el-date-picker>
                </el-form-item> -->
                <el-form-item label="活动名称">
                    <el-input  clearable  class="topInput"  v-model="name"></el-input>
                </el-form-item>

                <el-form-item label="测试人员">
                    <el-input  clearable class="topInput"></el-input>
                </el-form-item>
